                                ...
                                <div class="modal-body">
                                    <form action="{{ route('divisi.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label for="namadivisi"><b>Nama Divisi</b></label>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a onclick="confirmation(event)"
                                                    href="{{ route('divisi.destroy', ['id' => $item->id]) }}"
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('divisi.update', $item->id) }}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <label for="diviisi_id"><b>Nama Divisi</b></label>
                                                                    <input type="text" class="form-control"
                                                                        id="nama" value="{{ $item->nama }}"
                                                                        placeholder="Enter Nama Divisi" name="nama" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer border-top-0 d-flex">
