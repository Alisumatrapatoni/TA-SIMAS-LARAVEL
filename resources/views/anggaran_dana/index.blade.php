...
@section('menunya')
<h2>
    Master <i class="fa fa-solid fa-arrow-right"></i> Data Anggaran Dana
</h2>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Anggaran Dana</h4>
                    @if (session('error'))
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h3 class="modal-title"><b>Tambah Anggaran Dana</b></h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                    </button>
                                </div>

                                <div class="modal-body">
                                    <form action="{{ route('anggaran_dana.store') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label><b>Nama Anggaran Dana</b></label>
                                                    <input type="text" class="form-control" id="nama"
                                                        placeholder="Masukkan Nama Anggaran Dana" name="nama" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a onclick="confirmation(event)"
                                                    href="{{ route('anggaran_dana.destroy', ['id' => $item->id]) }}"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <img src="{{ asset('simas/images/smkn1kalianget.png') }}"
                                                        alt="" width="70px">
                                                    <h3 class="modal-title"><b>Edit Anggaran Dana</b></h3>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="{{ route('anggaran_dana.update', $item->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <label for="iduser"><b>Nama Anggaran Dana</b></label>
                                                                    <input type="text" class="form-control"
                                                                        id="nama" value="{{ $item->nama }}"
                                                                        placeholder="Masukkan Nama Anggaran Dana" name="nama"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
